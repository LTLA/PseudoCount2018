...
\begin{flushleft}
{\Large
    \textbf\newline{Log-transformation introduces systematic errors in normalized single-cell RNA sequencing data}
}
\newline
...
We show that the log-transformation can introduce systematic differences between cells with different coverage,
...
However, in practice, downstream procedures such as clustering will compare many cells to one another.
...
\centering
\begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth,trim=0mm 5mm 0mm 5mm,clip,page=2]{../scripts/pics/real_pbmc.pdf}
    \caption{}
\end{subfigure}
\begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth,trim=0mm 5mm 0mm 5mm,clip,page=3]{../scripts/pics/ercc.pdf}
    \caption{}
\end{subfigure}
