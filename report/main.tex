...
\[
\Delta_{12} \approx \frac{\mbox{var}(X_1)s_1^{-2} -  \mbox{var}(X_2)s_2^{-2}}{2(\mu + c)^2} \;.
\]
...
We performed simulations to quantify this spurious difference across a variety of scenarios (Figure~\ref{fig:maxeffect}).
The difference was most prominent when the size factors were different and either or both of them were less than unity.
This is consistent with the above expression for $\Delta_{12}$, which increases in magnitude with smaller $s_i$.
