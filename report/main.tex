...
To this end, we would also expect the chosen $c$ to be comparable to the magnitude of $E(X_{ig}/s_i)$.
...
The proportionality constant for $c$ is also set to unity, which provides a compromise between restricting $\tilde\Delta_{12g}$ and keeping the pseudo-count as small as possible.
