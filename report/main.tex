...
which suggests that favouring transformations on the basis of variance stabilization is largely misguided.
...
Any benefit from an increased pseudo-count requires that the reduction in error is greater than the shrinkage of genuine biological differences, and this is not guaranteed.
