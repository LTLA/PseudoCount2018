...
\begin{flushleft}
{\Large
    \textbf\newline{Overcoming systematic errors caused by log-transformation of normalized single-cell RNA sequencing data}
}
\newline
...
However, this is more difficult to justify as there is no straightforward interpretation for an ``acceptable'' threshold in the error in the distance between cells.
