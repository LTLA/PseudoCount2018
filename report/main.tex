...
This is fully attributable to the log-transformation, as no such difference is present in the log-fold change between the mean counts after normalization (Figure~\ref{fig:ercc}b).
